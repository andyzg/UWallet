...
public class WatcardInfo {
	...
	private double flexDollar;
	private double mealDollar;
	
	public WatcardInfo(ArrayList<Transaction> list,double flexDollar, double mealDollar, int studentID, int PIN)
	{
		this.mInstance = true;
		this.transList = list;
		this.flexDollar = flexDollar;
		this.mealDollar = mealDollar;
